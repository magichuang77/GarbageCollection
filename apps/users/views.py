...
from GarbageCollection.settings import WEB_SYSTEM_NAME
from GarbageCollection.settings import EMAIL_FROM
from .models import VerifyCode
from .serializers import VerifyCodeSerializer, UserRegSerializer, UserDetailSerializer, UserUpdateSerializer
...
class VerifyCodeViewSet(CreateModelMixin, viewsets.GenericViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        email_title = "{}——邮箱操作验证码".format(WEB_SYSTEM_NAME)
